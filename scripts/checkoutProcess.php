...
function displayReceiptHeader(){
    ...
    <h4 class='w3-center'>
        ...
        echo "
        <div style= 'overflow-x:auto;'><table class='w3-table w3-border w3-border-right'
            <tr>
                <th>Product Image</th>
                <th>Product Name</th>
                <th>Price</th>
...
function displayReceiptFooter($grandTotal){
    ...
    "<tr>
        ...
        <td colspan='5'>
            ...
            <br>Thank you very much for shopping with Innovative Inventories.
            <br> We appreciate your purchase of the above product(s).
            <br>You may pring a copy of this page for your permanent record.
...
function markOrderItemsPaid($db, $orderID){
    ...
    for($i=1; $i<$numRecords; $i++){
        ...
        if(!$success){
            echo "ERROR: UPDATE failure in markOrderItemsPaid
                  in checkoutProcess";
            exit(0);
        }
