<!-- formFeedbackProcess.php for Innovative Inventory, version 4 -->
<!DOCTYPE html>
    ...
    <main class="w3-container">
        <div class="w3-container w3-border-left w3-border-right
            ...
            <article>
                ...
                <p class=" error w3-center" style="color:red">Each * denotes a required field.</p>
                <form id="contactForm" action="scripts/formFeedbackProcess.php" method="post">
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <p>
                                <select name=" salutation" required class="w3-yellow">
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <p>
                                <input type="text" class="w3-yellow" name="firstName" required
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <p>
                                <input type="text" class="w3-yellow" name="lastName" required
                                    title="Initial capital, spaces, hyphens&#010;and apostrophes allowed."
                                    style="width: 100%;" pattern="^[A-Z][A-Za-z '-]*$">
                            </p>
                        </div>
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <p>
                                <input type="text" class="w3-yellow" name="email" required
                                    title="x@y.z x and y alphnumeric, . or -, z 2 or 3 letters" style="width: 100%;"
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container w3-wide">
                            <p>
                                <input type="text" class="w3-yellow" name="phone"
                                    title="xxx-yyy-zzzz, area code xxx- optional" style="width: 100%;"
                                    pattern="^(\d{3}-)?\d{3}-\d{4}$">
                            </p>
                        </div>
                    </div>
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <p>
                                <input type="text" class="w3-yellow" name="subject" required style="width: 100%;">
                            </p>
                        </div>
                    </div>
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <p>
                                <textarea name="message" class="w3-yellow" rows="6" required
                    ...
                    <div class="w3-row">
                        ...
                        <div class="w3-twothird w3-container">
                            <p>
                                <input type="submit" value="Send Feedback" class="w3-orange">
                                <input type="reset" value="Reset Form" class="w3-orange">
                            </p>
                        </div>
                    </div>
                </form>
